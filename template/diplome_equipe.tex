...
%=============================
    ...
    \begin{minipage}[c]{6in}
        {\centering
        {\onehalfspacing
        {\Large\fontcommand { { {{ number }} Tournoi Français des
        Jeunes Mathématiciennes et Mathématiciens}}}\\
        {\large\fontcommand {{ name }} -- {{ date }} \\}}
        \par}
    \end{minipage}
    %
    \hfill
    ...
    \begin{center}
    {\doublespacing\Large\fontcommand Un \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\\[0.5em]
    est décerné à l'équipe {\sffamily \MakeUppercase{\team}}, composée de}
        ...
        \else
        \begin{tabular}{lll}
            \pra\ \MakeUppercase{\nma} & \prb\ \MakeUppercase{\nmb} & \prc\ \MakeUppercase{\nmc}\\
            \prd\ \MakeUppercase{\nmd} & \pre\ \MakeUppercase{\nme} & \prf\ \MakeUppercase{\nmf}
        \end{tabular}
        \fi

    {\large\fontcommand et encadrée par\\}
    \begin{tabular}{lll}
